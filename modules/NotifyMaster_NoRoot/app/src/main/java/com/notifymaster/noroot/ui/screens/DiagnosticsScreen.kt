...
fun DiagnosticsScreen() {
    ...
    Column(
        ...
        DiagCard(
            ...
            detail = if (shizukuActive) "Shizuku 服务运行中，NoRoot 版主要靠应用层 Hook，Shizuku 仅作辅助诊断"
                     else "Shizuku 未运行或未授权。NoRoot 版应用层功能不受影响",
            ok = shizukuActive
        )
        Spacer(Modifier.height(8.dp))
        ...
        Card(modifier = Modifier.fillMaxWidth(),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text("• NoRoot 版仅 Hook 应用进程内通知调用，不修改系统通知服务", style = MaterialTheme.typography.bodySmall)
            }
        }
