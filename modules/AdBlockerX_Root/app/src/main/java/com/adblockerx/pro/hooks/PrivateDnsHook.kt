 ...
 *  - 修改 Private DNS 会影响整机所有 APP 的 DNS 查询
 *  - 用户可填入自己的广告过滤 DNS（如 dns.adblockplus.org、adguard_dns 等）
 *  - 提供恢复为自动/关闭的方法
 */
