...
fun DiagnosticsScreen() {
    ...
    Column(
        ...
        DiagCard(
            ...
            detail = if (shizukuActive) "Shizuku 服务运行中，Root 版系统级 Hook（SystemNotifyHook/NotifyListenerServiceHook 等）可正常工作"
        ...
        Card(modifier = Modifier.fillMaxWidth(),
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Text("• Root 版系统级 Hook 必须先 Shizuku 可用，否则降级为应用层 Hook", style = MaterialTheme.typography.bodySmall)
            }
        }
